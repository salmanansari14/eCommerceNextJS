...
const Post = ({ addToCart }) => {
    ...
    console.log('slghslg',addToCart)
    const checkServiceability = async () => {
        // let pins = await fetch('http://localhost:3000/api/route')
        // let pinJson = pins.json()
        let pins = [211003, 211006, 211002]
            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51GCKIaaFSL._SY300_SX300_QL70_FMwebp_.jpg" />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-sm md:px-6">
                                    Buy now
                                </button>
                                <button onClick={() => { addToCart(slug, 1, 499, 'Wear to Code(Xl, Red)', 'XL', "Red") }}
                                    className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-sm md:px-6">
                                    Add to Cart
                                </button>
                            ...
                            <div className="pin mt-6 flex space-x-2 text-sm">
                                <input type="text" placeholder='Enter your pincode' onChange={onChang} className='px-2 border-2 border-gray-400 rounded-md' />
                            ...
                            {!service && service != null && <div className="text-red-700 text-sm mt-3">
                                Sorry! we do not deliver to the pincode yet
                            </div>
                            }
                            {service && service != null && <div className="text-green-700 text-sm mt-3">
                                yay! this pioncode is servicable
                            </div>
                            }
                        </div>
                    </div>
